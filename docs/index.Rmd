---
title: "How Mobile Are NYC's Housing Choice Voucher Users?"
subtitle: "An Analysis of the 2017 New York City Housing & Vacancy Survey"
output: 
  html_document:
    theme: flatly
---
...
```{r fig-margin3, fig.fullwidth = TRUE, cache=TRUE, message=FALSE, echo=FALSE, out.width='100%'}
knitr::include_graphics('plots/sankey.svg')
```
...
5.  Set survey design parameters for accurate weighted estimates. I used Stata's -svset- function, but you can also use R's *survey* package or similar. See this UCLA [tutorial](stats.idre.ucla.edu/stata/seminars/survey-data-analysis-in-stata-17) on working with sampling weights in Stata.
